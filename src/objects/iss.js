...
import { issMaterials } from '../materials/issMaterials';
import { issParameters } from '../parameters/parameters';

export function createISS(isReal) {
    // геометрии
    ...
    const mainPart3 = new THREE.Mesh(cylGeometry6, issMaterials.whiteMaterial);
    ...
    const secondPart1 = new THREE.Mesh(cylGeometry2, issMaterials.grayMaterial);
    secondPart1.position.set(0, 22, 0);
    ISS.add(secondPart1);

    const secondPart2 = new THREE.Mesh(cylGeometry2, issMaterials.grayMaterial);
    ...
    const battery1 = new THREE.Mesh(planeGeometry1, issMaterials.orangeMaterial);
    ISS.add(battery1);
    battery1.rotateX(Math.PI / 2);
    battery1.rotateY(Math.PI / 2);
    battery1.position.set(0, 20, 11)

    const battery2 = new THREE.Mesh(planeGeometry1, issMaterials.orangeMaterial);
    ISS.add(battery2);
    battery2.rotateX(Math.PI / 2);
    battery2.rotateY(Math.PI / 2);
    battery2.position.set(0, 20, -11)

    const battery3 = new THREE.Mesh(planeGeometry1, issMaterials.orangeMaterial);
    ISS.add(battery3);
    battery3.rotateX(Math.PI / 2);
    battery3.rotateY(Math.PI / 2);
    battery3.position.set(0, 26, 11)

    const battery4 = new THREE.Mesh(planeGeometry1, issMaterials.orangeMaterial);
    ISS.add(battery4);
    battery4.rotateX(Math.PI / 2);
    battery4.rotateY(Math.PI / 2);
    battery4.position.set(0, 26, -11)

    const battery5 = new THREE.Mesh(planeGeometry1, issMaterials.orangeMaterial);
    ISS.add(battery5);
    battery5.rotateX(Math.PI / 2);
    battery5.rotateY(Math.PI / 2);
    battery5.position.set(0, -20, 11)

    const battery6 = new THREE.Mesh(planeGeometry1, issMaterials.orangeMaterial);
    ISS.add(battery6);
    battery6.rotateX(Math.PI / 2);
    battery6.rotateY(Math.PI / 2);
    battery6.position.set(0, -20, -11)

    const battery7 = new THREE.Mesh(planeGeometry1, issMaterials.orangeMaterial);
    ISS.add(battery7);
    battery7.rotateX(Math.PI / 2);
    battery7.rotateY(Math.PI / 2);
    battery7.position.set(0, -26, 11)

    const battery8 = new THREE.Mesh(planeGeometry1, issMaterials.orangeMaterial);
    ISS.add(battery8);
    battery8.rotateX(Math.PI / 2);
    battery8.rotateY(Math.PI / 2);
    battery8.position.set(0, -26, -11)

    const balka1 = new THREE.Mesh(cylGeometry4, issMaterials.blackMaterial);
    ISS.add(balka1);
    balka1.position.set(0, -26, 0);
    balka1.rotateX(Math.PI / 2);

    const balka2 = new THREE.Mesh(cylGeometry4, issMaterials.blackMaterial);
    ISS.add(balka2);
    balka2.position.set(0, -20, 0);
    balka2.rotateX(Math.PI / 2);

    const balka3 = new THREE.Mesh(cylGeometry4, issMaterials.blackMaterial);
    ISS.add(balka3);
    balka3.position.set(0, 20, 0);
    balka3.rotateX(Math.PI / 2);

    const balka4 = new THREE.Mesh(cylGeometry4, issMaterials.blackMaterial);
    ISS.add(balka4);
    ...
    const balka5 = new THREE.Mesh(cylGeometry5, issMaterials.lightGrayMaterial);
    ISS.add(balka5);
    balka5.position.set(11, 0, 0);
    balka5.rotateX(Math.PI / 2);

    const balka6 = new THREE.Mesh(cylGeometry5, issMaterials.lightGrayMaterial);
    ISS.add(balka6);
    balka6.position.set(5, 0, 0);
    balka6.rotateX(Math.PI / 2);

    const battery9 = new THREE.Mesh(planeGeometry2, issMaterials.blueMaterial);
    ISS.add(battery9);
    ...
    const battery10 = new THREE.Mesh(planeGeometry2, issMaterials.blueMaterial);
    ISS.add(battery10);
    ...
    const battery11 = new THREE.Mesh(planeGeometry2, issMaterials.blueMaterial);
    ISS.add(battery11);
    ...
    const battery12 = new THREE.Mesh(planeGeometry2, issMaterials.blueMaterial);
    ISS.add(battery12);
    ...
    const balka7 = new THREE.Mesh(cylGeometry7, issMaterials.blackMaterial);
    ISS.add(balka7);
    balka7.position.set(4, 7, 0);
    balka7.rotateZ(Math.PI / 2);

    const balka8 = new THREE.Mesh(cylGeometry7, issMaterials.blackMaterial);
    ISS.add(balka8);
    balka8.position.set(4, 8, 0);
    balka8.rotateZ(Math.PI / 2);

    const balka9 = new THREE.Mesh(cylGeometry7, issMaterials.blackMaterial);
    ISS.add(balka9);
    balka9.position.set(4, -7, 0);
    balka9.rotateZ(Math.PI / 2);

    const balka10 = new THREE.Mesh(cylGeometry7, issMaterials.blackMaterial);
    ISS.add(balka10);
    balka10.position.set(4, -8, 0);
    balka10.rotateZ(Math.PI / 2);

    const battery13 = new THREE.Mesh(planeGeometry3, issMaterials.silverMaterial);
    ISS.add(battery13);
    battery13.rotateZ(Math.PI / 2);
    battery13.position.set(5, -7.5, 0);

    const battery14 = new THREE.Mesh(planeGeometry3, issMaterials.silverMaterial);
    ISS.add(battery14);
